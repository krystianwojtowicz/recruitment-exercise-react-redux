...
const Form = ({
    ...
    const handleOnSubmit = event => {
        ...
        Axios.post(url, JSON.stringify({
            name: nameInput,
            preparation_time: nameInput,
            type: typeSelect,
            no_of_slices: parseInt(sliceInput),
            diameter: parseInt(diameterInput),
            spiciness_scale: parseInt(spicinessInput),
            slices_of_bread: parseInt(breadInput)
          }))
            .then(res => {
...
//     names: store.names,
// })
// const FormConsumer = connect(connectReduxStateToProps)(Form);
